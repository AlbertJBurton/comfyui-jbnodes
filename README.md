...
> **Film grain note:** Prior versions used `moderngl` (OpenGL) for GPU-accelerated grain.
> The grain engine now runs on numpy/torch/scipy with no system-level graphics
> dependencies.  No X11, EGL, or OpenGL libraries are required.
